YL.static = {
  /** “关于”信息 */
  softwareName: '小航の小窝', //网站名。请在此处填写您自己的网站名，如王小明的博客。
  version: "2.1.9", // 网站版本号
  iconBtnStart: 'html5', //主图标
  author: '小航',//作者
  contactInformation: 'QQ:3158485458',//联系方式
  officialWebsite: 'https://小航的小窝.xyz',//软件官网
  welcome: '本项目由憨憨の小航勉强运行\n更多信息：//https://xn--yeta234r6xdcxl.xyz',//加载完毕控制台提示信息
  copyrightDetail: '©2021 - 小航',//版权详细信息
