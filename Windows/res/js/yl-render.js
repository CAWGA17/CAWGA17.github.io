    ...
    methods: {
      ...
      initRuntime: function (first) {
        ...
        if (first && !YL.static.serialNumber) {
          YL.onReady(function () {
            setTimeout(function () {
              YL.msg("小航的Windows v" + YL.info.version + " ", 'HI~欢迎来到小航的小窝~QwQ<br/>这是一个Web的Windows桌面项目<br/>小航のQQ链接：' + '<a style="color: white" target="_blank" href="https://qm.qq.com/cgi-bin/qm/qr?k=KWqGUDQWZg2b9fMtOKG7jA-EQLl2MXCs&noverify=0">呐呐呐点这里~UwU</a><p>喜欢我的话。。。就请小航顿饭吧！（憨憨小航在线求投喂QAQ）<br/><br/><img style="width: 100%" src="./res/img/donation.png"/></p>');
            }, 1500)
          });
        }
